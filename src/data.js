...
export const data = {
  ...
  "heroData": {
    ...
    "socialData": [
      {
        "link": "https://github.com/m0nusharma",
        "icon": "github"
      },
      {
        "link": "https://www.instagram.com/_monushrma__/",
        "icon": "instagram"
      },
      {
        "link": "https://www.linkedin.com/in/monu-sharma-434485264/",
        "icon": "linkedin"  
      }
    ]
  },
  "aboutData": {
    ...
    "aboutRight": {
      ...
      "contactInfo": [
        ...
        {
          "icon": "envelope",
          "data": "sharmamonu42969@gmail.com"
        },
        {
          "icon": "map",
          "data": "Panchkula, Haryana"
        }
      ],
      "archivement": [
        {
          "number": "01+",
          "meta": "Years <br /> Learning",
          "text": "Hello there! My name is <span>Monu Sharma</span>. I am a web designer & developer, and Im very passionate and dedicated to my work."
        },
        {
          "number": "10+",
          "meta": "Project Complete",
          "text": "With 10+ projects, I'm a seasoned designer ready to bring success to your project with diverse skills and experience."
        }
      ],
      "note": "“Detail-oriented web designer driven to create impactful digital spaces. Skilled in HTML, CSS, and dedicated to enhancing user engagement through thoughtful design.”"
    }
  },
  "experienceData": {
    ...
    "experience": [
      ...
      },
      {
        ...
        "end": "2020",
        "title": "10TH ",
        "subtitle": "Govt Model Senior Secondary School, Chandigarh"
      }
    ]
  },
  "serviceData": [
  ...
  "portfolioData": [
    ...
    },
    {
      ...
      "paragraphList": [
        {
          "text": "In my web development portfolio, I proudly showcase a social media web application designed and implemented using React. This project represents a harmonious blend of cutting-edge technology and thoughtful user experience. Leveraging React's component-based structure, the application achieves a high level of modularity, ensuring scalability and easy maintenance. The user interface is meticulously crafted to deliver a seamless and engaging experience, allowing users to connect, share, and interact in an intuitive and visually appealing environment."
        },
        {
          "text": "The heart of the social media web application lies in its dynamic and responsive design. React's real-time rendering capabilities enhance user interactions, providing instant feedback and updates. Through an aesthetically pleasing layout and carefully chosen color schemes, the application not only meets functional requirements but also prioritizes user enjoyment. Features such as real-time notifications, customizable profiles, and a fluid news feed contribute to an immersive and satisfying user journey, making the application stand out in the competitive landscape of social media platforms."
        },
        {
          "text": "Furthermore, the React-powered social media web application underscores my commitment to creating meaningful and impactful digital experiences. The inclusion of responsive design principles ensures accessibility across various devices, fostering inclusivity and reaching a broad user demographic. As a testament to my skills in React development, this project reflects my dedication to pushing the boundaries of web design, offering users a platform that not only meets their social networking needs but also delights them with a visually appealing and seamlessly functional interface."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphList": [
        {
          "text": "Within my web development repertoire, I take pride in presenting a static web design clone of Flipkart, meticulously crafted using HTML and CSS. This project exemplifies my proficiency in front-end development and showcases my ability to recreate complex and visually appealing interfaces. By closely studying Flipkart's user interface, I successfully replicated the layout, structure, and styling, demonstrating my attention to detail and dedication to delivering high-quality web designs."
        },
        {
          "text": "The Flipkart static web design clone not only mirrors the aesthetics of the original e-commerce platform but also showcases my skills in creating responsive and user-friendly interfaces. The HTML and CSS implementation ensures a seamless user experience across various devices, capturing the essence of Flipkart's dynamic product displays and intuitive navigation. The attention to detail in replicating Flipkart's visual identity, from color schemes to typography, underscores my commitment to precision in web design."
        }
  ...
  "contactData": {
    "contactInfo": [
      {
        ...
        "title": "Gmail ",
        "text": "",
        "emailLink": "sharmamonu42969@gmail.com"
      },
      {
        "icon": "compass",
        "title": "Visit us",
    ...
    "contactForm": {
      ...
      "text": "Know more about my self Contact me."
    }
  },
  "footerData": {
    "ImgLink": Profile,
  ...
  "socialData": [
    {
      "icon": "twitter",
      "link": "https://twitter.com/_monushrma"
    },
    {
      "icon": "instagram",
      "link": "https://www.instagram.com/_monushrma__/"
